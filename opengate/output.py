...
from opengate.comms.ws import WebSocket
from opengate.config import BirdseyeModeEnum, OpenGateConfig
from opengate.const import BASE_DIR, BIRDSEYE_PIPE
from opengate.types import CameraMetricsTypes
...
class BirdsEyeFrameManager:
    def __init__(
        ...
        # initialize the frame as black and with the OpenGate logo
        ...
        if birdseye_logo is None:
            logo_files = glob.glob("/opt/opengate/opengate/images/birdseye.png")
        ...
        if birdseye_logo is not None:
            ...
            logger.warning("Unable to read OpenGate logo")
