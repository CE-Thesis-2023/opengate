...
from opengate.config import DetectConfig, ModelConfig
...
from opengate.detectors.detector_config import PixelFormatEnum
from opengate.models import Event, Regions, Timeline
