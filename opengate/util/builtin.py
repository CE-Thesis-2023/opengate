...
from opengate.const import REGEX_HTTP_CAMERA_USER_PASS, REGEX_RTSP_CAMERA_USER_PASS
...
def clear_and_unlink(file: Path, missing_ok: bool = True) -> None:
    ...
    # empty contents of file before unlinking https://github.com/blakeblackshear/opengate/issues/4769
    with open(file, "w"):
        pass
