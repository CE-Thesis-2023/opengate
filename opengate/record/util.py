...
from opengate.const import RECORD_DIR
from opengate.models import Recordings, RecordingsToDelete
...
def sync_recordings(limited: bool) -> None:
    ...
    def delete_db_entries_without_file(check_timestamp: float) -> bool:
        """Delete db entries where file was deleted outside of opengate."""
    ...
    def delete_files_without_db_entry(files_on_disk: list[str]):
        """Delete files where file is not inside opengate db."""
        files_to_delete = []
