...
from opengate.config import CameraConfig, OpenGateConfig, ZoomingModeEnum
...
from opengate.util.builtin import update_yaml_file
from opengate.util.image import SharedMemoryFrameManager, intersection_over_union
...
class PtzAutoTracker:
    ...
    def _autotracker_setup(self, camera_config, camera):
        ...
        logging.info(f"Autotracker setup: {self.onvif.cams}")
