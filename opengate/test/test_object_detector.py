...
import opengate.detectors as detectors
import opengate.object_detection
from opengate.config import DetectorConfig, ModelConfig
from opengate.detectors import DetectorTypeEnum
from opengate.detectors.detector_config import InputTensorEnum
...
class TestLocalObjectDetector(unittest.TestCase):
        ...
        for det_type in detectors.api_types:
            with self.subTest(det_type=det_type):
                with patch.dict(
                    ...
                    test_obj = opengate.object_detection.LocalObjectDetector(
    ...
    def test_detect_raw_given_tensor_input_should_return_api_detect_raw_result(self):
        ...
        test_obj_detect = opengate.object_detection.LocalObjectDetector(
    ...
    @patch("opengate.object_detection.load_labels")
