...
class TestConfig(unittest.TestCase):
    ...
    def test_config_class(self):
        opengate_config = OpenGateConfig(**self.minimal)
        assert self.minimal == opengate_config.dict(exclude_unset=True)
    ...
    def test_detector_custom_model_path(self):
        ...
        opengate_config = OpenGateConfig(**(deep_merge(config, self.minimal)))
        runtime_config = opengate_config.runtime_config()
    ...
    def test_invalid_mqtt_config(self):
        ...
        self.assertRaises(ValidationError, lambda: OpenGateConfig(**config))
    ...
    def test_fails_on_missing_role(self):
        ...
        opengate_config = OpenGateConfig(**config)
        self.assertRaises(ValueError, lambda: opengate_config.runtime_config())
    ...
    def test_works_on_missing_role_multiple_cams(self):
        ...
        opengate_config = OpenGateConfig(**config)
        opengate_config.runtime_config()
    ...
    def test_fails_on_bad_camera_name(self):
        ...
        self.assertRaises(
            ValidationError, lambda: opengate_config.runtime_config().cameras
        )
    ...
    def test_fails_on_bad_segment_time(self):
        ...
        self.assertRaises(
            ValueError,
            lambda: opengate_config.runtime_config().ffmpeg.output_args.record,
        )
    ...
    def test_fails_zone_defines_untracked_object(self):
        ...
        self.assertRaises(ValueError, lambda: opengate_config.runtime_config().cameras)
    ...
    def test_fails_invalid_movement_weights(self):
        ...
        self.assertRaises(ValueError, lambda: OpenGateConfig(**config))
