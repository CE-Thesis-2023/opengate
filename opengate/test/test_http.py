...
class TestHttp(unittest.TestCase):
        ...
        self.test_stats = {
            ...
            "service": {
                "storage": {
                    ...
                    "/media/opengate/clips": {
                        "free": 42429.9,
                        "mount_type": "ext4",
                        "total": 244529.7,
                        "used": 189607.0,
                    },
                    "/media/opengate/recordings": {
                        "free": 0.2,
                        "mount_type": "ext4",
                        "total": 8.0,
                        "used": 7.8,
    ...
    def test_get_event_list(self):
        app = create_app(
            OpenGateConfig(**self.minimal_config),
            self.db,
            None,
            None,
            None,
    ...
    def test_config(self):
        app = create_app(
            OpenGateConfig(**self.minimal_config).runtime_config(),
            self.db,
            None,
            None,
            None,
    ...
    @patch("opengate.http.stats_snapshot")
