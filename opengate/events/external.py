...
from opengate.config import CameraConfig, OpenGateConfig
from opengate.const import CLIPS_DIR
from opengate.events.maintainer import EventTypeEnum
from opengate.util.image import draw_box_with_label

logger = logging.getLogger(__name__)


class ExternalEventProcessor:
    def __init__(self, config: OpenGateConfig, queue: Queue) -> None:
        self.config = config
        self.queue = queue
