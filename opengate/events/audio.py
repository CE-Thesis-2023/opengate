...
from opengate.config import CameraConfig, CameraInput, FfmpegConfig, OpenGateConfig
...
from opengate.object_detection import load_labels
from opengate.types import CameraMetricsTypes, FeatureMetricsTypes
from opengate.util.builtin import get_ffmpeg_arg_list
from opengate.util.services import listen
from opengate.video import start_or_restart_ffmpeg, stop_ffmpeg
...
def listen_to_audio(
    ...
    setproctitle("opengate.audio_manager")
    listen()
