...
from opengate.comms.dispatcher import Communicator, Dispatcher
from opengate.comms.inter_process import InterProcessCommunicator
from opengate.comms.mqtt import MqttClient
from opengate.comms.ws import WebSocketClient
...
from opengate.events.cleanup import EventCleanup
from opengate.events.external import ExternalEventProcessor
from opengate.events.maintainer import EventProcessor
from opengate.http import create_app
from opengate.log import log_process, root_configurer
from opengate.models import Event, Recordings, RecordingsToDelete, Regions, Timeline
...
from opengate.record.record import manage_recordings
from opengate.stats import StatsEmitter, stats_init
...
class OpenGateApp:
    ...
    def start_watchdog(self) -> None:
        self.opengate_watchdog = OpenGateWatchdog(self.detectors, self.stop_event)
        self.opengate_watchdog.start()
    ...
    def start(self) -> None:
        ...
        try:
            ...
            try:
                ...
                print("***    https://docs.opengate.video/configuration/index     ***")
                print("*************************************************************")
                print("*************************************************************")
