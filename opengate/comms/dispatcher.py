"""Handle communication between OpenGate and other applications."""
...
from opengate.const import INSERT_MANY_RECORDINGS, REQUEST_REGION_GRID
from opengate.models import Recordings
from opengate.ptz.onvif import OnvifCommandEnum, OnvifController
...
from opengate.util.services import restart_opengate
...
class Dispatcher:
    """Handle communication between OpenGate and communicators."""
