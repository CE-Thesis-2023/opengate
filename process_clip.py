...
sys.path.append("/workspace/opengate")

from opengate.config import OpenGateConfig  # noqa: E402
from opengate.motion import MotionDetector  # noqa: E402
from opengate.object_detection import LocalObjectDetector  # noqa: E402
from opengate.object_processing import CameraState  # noqa: E402
from opengate.track.centroid_tracker import CentroidTracker  # noqa: E402
from opengate.util import (  # noqa: E402
    EventsPerSecond,
    SharedMemoryFrameManager,
    draw_box_with_label,
)
from opengate.video import (  # noqa: E402
    capture_frames,
    process_frames,
...
class ProcessClip:
    def __init__(self, clip_path, frame_shape, config: OpenGateConfig):
...
def process(path, label, output, debug_path):
    ...
    for c in clips:
        ...
        opengate_config = OpenGateConfig(**json_config)
