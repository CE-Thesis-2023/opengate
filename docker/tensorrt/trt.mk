...
local-trt: version
	$(X86_DGPU_ARGS) docker buildx bake --load --file=docker/tensorrt/trt.hcl --set tensorrt.tags=opengate:latest-tensorrt tensorrt

local-trt-jp4: version
	$(JETPACK4_ARGS) docker buildx bake --load --file=docker/tensorrt/trt.hcl --set tensorrt.tags=opengate:latest-tensorrt-jp4 tensorrt

local-trt-jp5: version
	$(JETPACK5_ARGS) docker buildx bake --load --file=docker/tensorrt/trt.hcl --set tensorrt.tags=opengate:latest-tensorrt-jp5 tensorrt
