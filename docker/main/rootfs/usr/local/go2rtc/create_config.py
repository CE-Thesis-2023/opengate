...
sys.path.insert(0, "/opt/opengate")
from opengate.const import BIRDSEYE_PIPE  # noqa: E402
from opengate.ffmpeg_presets import (  # noqa: E402
...
# Need to enable CORS for go2rtc so the opengate integration / card work automatically
...
# as source for opengate and the integration supports HLS playback
...
# may be removed if opengate uses a go2rtc version that includes these presets
if go2rtc_config.get("ffmpeg") is None:
    go2rtc_config["ffmpeg"] = {
