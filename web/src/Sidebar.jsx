...
export default function Sidebar() {
  ...
  return (
    <NavigationDrawer header={<Header />}>
      ...
      <Destination className="self-end" href="https://docs.opengate.video" text="Documentation" />
      <Destination className="self-end" href="https://github.com/blakeblackshear/opengate" text="GitHub" />
    </NavigationDrawer>
  );
}
