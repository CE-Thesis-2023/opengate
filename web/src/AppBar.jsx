...
import OpenGateRestartIcon from './icons/OpenGateRestart';
    ...
    <Fragment>
      ...
      {showMoreMenu ? (
        <Menu onDismiss={handleDismissMoreMenu} relativeTo={moreRef}>
          ...
          <MenuSeparator />
          <MenuItem icon={OpenGateRestartIcon} label="Restart OpenGate" onSelect={handleRestart} />
        </Menu>
      ) : null}
      {showDialog ? (
        <Prompt
          onDismiss={handleDismissRestartDialog}
          title="Restart OpenGate"
          text="Are you sure?"
          actions={[
