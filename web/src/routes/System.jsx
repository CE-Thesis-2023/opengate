    ...
    <div className="space-y-4 p-2 px-4">
      ...
      {!detectors ? (
        ...
        <Fragment>
          ...
          {!gpu_usages ? (
            <div className="p-4">
              <Link href={'https://docs.opengate.video/configuration/hardware_acceleration'}>
                  ...
                  <div className="p-2">
                    {gpu_usages[gpu]['gpu'] == -1 ? (
                      <div className="p-4">
                        ...
                        Either your GPU does not support this or OpenGate does not have proper access to get statistics.
